...
make_figure("docking/diffdock_nrp1/extracted/complex_0/6FMC.pdb",
            "docking/diffdock_nrp1/extracted/complex_0/rank1_confidence-1.51.sdf",
            "Nrp1 (6FMC) - Imatinib top DiffDock pose (confidence -1.51)\nconverges within 1.9 A of the Vina-defined EG01377 pocket",
            "figures/Imatinib_Nrp1_binding_pose.png")

make_figure("docking/diffdock_plxna1/extracted/complex_0/7Y4P.pdb",
            "docking/diffdock_plxna1/extracted/complex_0/rank1_confidence-1.65.sdf",
            "Plxna1 (7Y4P) - Imatinib top DiffDock pose (confidence -1.65)\n22.7 A from the Sema-domain Vina box (different site)",
            "figures/Imatinib_Plxna1_binding_pose.png")
